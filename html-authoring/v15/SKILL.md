---
name: html-authoring
description: Use this skill when generating or modifying single-page interactive teaching HTML (animations, single-page courseware, teaching posters, teaching web pages, printable workbooks / Chinese-character writing-practice sheets). It covers visual-design decisions and technical-implementation specifications (color scheme & layout, animation selection, browser compatibility, media assets). NOT applicable to multi-page PPT courseware, pure-knowledge Q&A, or any scenario that does not involve HTML.
---
