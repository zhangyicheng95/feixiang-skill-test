...
background: #A4D7C4;
border: 1px solid rgba(44, 103, 81, 0.50);
border-radius: 16px; color: #02211C（按钮上的文字）
02:次要按钮/未选中按钮
background: #0D2E25;
border: 1px solid rgba(44, 103, 81, 0.50);
border-radius: 16px; color: #A4D7C4（按钮上的文字）
...
background: #06B17A;
border: 1px solid rgba(238, 255, 235, 0.30);
border-radius: 16px; color: #FFFFFF（按钮上的文字）
02:次要按钮/未选中按钮
background: #184C49;
border: 1px solid rgba(238, 255, 235, 0.30);
border-radius: 16px; color: #EEFFEB（按钮上的文字）
...
background: #ECFCFB;
border: 1px solid rgba(0, 64, 77, 0.30);
border-radius: 16px; color: #00404D（按钮上的文字）
...
background: #B997F8;
border: 1px solid rgba(20, 20, 20, 0.30);
border-radius: 16px; color: #000000（按钮上的文字）
02:次要按钮/未选中按钮
background: #FBFBFA;
border: 1px solid rgba(20, 20, 20, 0.30);
border-radius: 16px; color: #000000（按钮上的文字）
