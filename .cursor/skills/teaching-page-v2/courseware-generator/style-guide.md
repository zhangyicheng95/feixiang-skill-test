...
> 本文件路径：`courseware-generator/style-guide.md`
...
- **画布底色（必做）**：`page-shared` 声明 `--canvas-bg`（见 `courseware-generator/feixiang-style.md` §4.6）；`html, body, .page-container` 使用 `background: var(--canvas-bg)`。
...
> **⚠️ 分批策略详见** `courseware-generator/content-guide.md` **第 5.3 节**。
>
