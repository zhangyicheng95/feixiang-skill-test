...
- **封面页例外**：第 1 页若使用设计老师封面版式，封面根容器和坐标规则按 `cover-layout-guide.md` 执行。
...
- 若第 1 页使用设计老师封面版式，具体版式选择、固定坐标、图片槽位和封面图适配规则只按 `cover-layout-guide.md` 执行；本文件不重复展开。
...
| 元素 | 上限 |
|------|------|
| 主标题 | 设计老师封面版式按 `cover-layout-guide.md` 执行；非设计版式保持简洁放大 |
| 副标题 | 设计老师封面版式按 `cover-layout-guide.md` 执行；非设计版式控制在 1~2 行 |
| 封面图片 | 设计老师封面版式按 `cover-layout-guide.md` 执行；非设计版式避免遮挡标题 |
...
- [ ] **未使用** `100vh`，一律用 `100%`
- [ ] 第 1 页如使用设计老师封面版式，已按 `cover-layout-guide.md` 执行
