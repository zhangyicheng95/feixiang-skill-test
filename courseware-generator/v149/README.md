...
- 读取文件：`retro-zine.md`
- 代码资产：
  `assets/retro-zine/tokens.css`
  `assets/retro-zine/page-shared.css`
  `assets/retro-zine/component-snippets.html`
...
- 读取文件：`8-bit-orbit.md`
- 代码资产：
  `assets/8-bit-orbit/tokens.css`
  `assets/8-bit-orbit/page-shared.css`
  `assets/8-bit-orbit/component-snippets.html`
