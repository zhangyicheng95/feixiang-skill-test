...
一屏展示所有交互，不要任何emoji表情和图片，UI card带有1px的描边，几何图形建议带有80%以上的填充保持视觉冲击力。卡片带有1px描边且颜色和主色调一致且透明度是30%，卡片统一圆角20px。必须根据我的色彩要求设计页面。
...
一级标题：font-size:42px，font-weight:700
二级标题：font-size:34px，font-weight:600
正文：font-size:28px
辅助说明：font-size:24px
