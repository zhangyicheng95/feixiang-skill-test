...
本技能把教研文字规范转成可执行工作流：**全量公式盘点 -> MathJax3 代码约束 -> 动态更新约束 -> 交互后自检 -> 不过即补丁修复**。
...
| `semantic_subscripts` | `vm/vM/v0/pm/pM/Px` 统一改为 `v_{m}/v_{M}/v_{0}/p_{m}/p_{M}/P_{x}` |
