...
| **v1.7.1** | **★ 圈点系统视觉重构：PCA 定向椭圆贴合笔画走向（横扁长 / 竖细高 / 撇捺斜倾，rx≤380 ry≥42 保底）+ 红圈延迟 800ms 出现（先笔迹后表扬，视觉层次清晰）+ 每圈附 ★ 红五角星表扬章（消除"圈是什么意思"的歧义）+ 文案首行"老师圈出 N 笔写得最好的"+ 默认 maxPraiseCircles 改为 2 + 7 个 PCA 单测** |
