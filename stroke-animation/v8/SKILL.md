...
**必须使用当前 skill 版本的附件 CDN。当前测试基线为 `stroke-animation/v8`，严禁引用旧版 `stroke-animation/v1` 到 `stroke-animation/v7` 的 `animation-loader.js`。**

```html
<script src="https://musk-test.fbcontent.cn/pub-musk-ai-studio/skills/stroke-order/v57/templates/stroke-loader.js"></script>
<script src="https://musk-test.fbcontent.cn/pub-musk-ai-studio/skills/stroke-animation/v8/templates/animation-loader.js"></script>
```
...
□  1a. animation-loader.js 是否使用当前版本 `/stroke-animation/v8/templates/animation-loader.js`，没有回退 v1-v7？
