...
- Lesson883 金样通过 Chrome 打印为 2 页。若移除内部自检后后台结果被压成 1 页，应让参考答案区成为独立 A4 答案页，例如 `.answer { break-before: page; page-break-before: always; }`，保持阅读密度和教师使用场景。不能通过添加“素材自检/排版自检”可见文字来撑页。
