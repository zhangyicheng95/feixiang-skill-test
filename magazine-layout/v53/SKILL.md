...
- 固定层：DOM 骨架、关键 class、标题层级、页眉页脚、题型模块、表格结构、答案区结构、布局方式、配色、字体字号、页边距、排版规则、打印 CSS token、技术规格。
...
- 参考 HTML 有 `.q-title`、`.language-box`、`.term-list`、`.checklist` 等内容组织 class，结果改成普通段落或把多个模块合并。
