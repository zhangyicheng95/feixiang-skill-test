...
10. 对 PDF/截图/扫描卷，若没有 OCR/文本转换出的完整题目结构，或图形依赖题没有真实题内图/裁剪 bbox，必须在生成文件前停止，回复“当前缺少 OCR 文本/题目结构化结果或题内图片裁剪结果，无法完成真正重排”；禁止用整页图片、局部识别结果或漂亮但不准确的重绘图冒充精美排版。
11. 未满足以上任一项时，必须重新生成或说明当前链路缺能力，禁止假装完成。
