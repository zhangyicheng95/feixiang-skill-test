...
```
数据文件：https://musk-test.fbcontent.cn/pub-musk-ai-studio/skills/stroke-order/v30/assets/stroke-data.json
加载器 ：https://musk-test.fbcontent.cn/pub-musk-ai-studio/skills/stroke-order/v30/templates/stroke-loader.js
```
...
```html
<script src="https://musk-test.fbcontent.cn/pub-musk-ai-studio/skills/stroke-order/v30/templates/stroke-loader.js"></script>
<script>
