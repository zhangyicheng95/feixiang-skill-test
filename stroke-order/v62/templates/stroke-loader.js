...
(function (global) {
  ...
  var textbookSet = null;     // Set: 小学教材字 2865 字（含 textbook-patch-v1 补丁字）
   ...
   *
   * tier 字段说明（v10.6+）：
   *   - 'textbook': 小学语文教材字（2865，含 textbook-patch-v1 补丁），3 轮教研审核，100% 可靠
   *   - 'extended': 字典扩展字（4953），自动映射 + 启发式，质量 >= 98% 但未完全审核
   *
   * LLM / UI 端策略建议：
