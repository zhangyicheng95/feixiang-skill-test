...
(function (global) {
  ...
  var DATA_URL = 'https://musk-test.fbcontent.cn/pub-musk-ai-studio/skills/stroke-order/v38/assets/stroke-data.json';
  ...
  function getStrokeData(char) {
    ...
    return { char: char, count: strokes.length, strokes: strokes.slice(), source: 'db', tier: tier };
  }
